...
?>  
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <div class="topnav">
            ...
            <a href="../ManagePharmacyView/spPharHome.php" style="margin-left: 5px;"><img src="../../includes/ExternalImage/rrms.png" width="110px" height="70px"><label style="font-size: 150%; padding-right: 5px;  font-family: URW Chancery L, cursive;">RRMS</label></a>

             <a href="../ManagePharmacyView/spitemList.php" style="margin-left: 30px;"><label style="font-size: 100%; padding-right: 5px; padding-top: 22px; padding-bottom: 20px;">Product List</label></a>

            <a href="../ManagePharmacyView/itemadd.php" style="margin-left: 30px;"><label style="font-size: 100%; padding-right: 5px; padding-top: 22px; padding-bottom: 20px;">Add Product</label></a>
