...
?>  
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">    
        ...
        <div class="topnav">
            ...
            <a href="../ManageFoodView/spAcceptFood.php" style="margin-left: 30px;"><label style="font-size: 100%; padding-right: 5px; padding-top: 22px; padding-bottom: 20px;">Manage Order</label></a>

             <a href="../ManageFoodView/spFoodList.php" style="margin-left: 30px;"><label style="font-size: 100%; padding-right: 5px; padding-top: 22px; padding-bottom: 20px;">My Food List</label></a>

            <a href="../ManageFoodView/addFood.php" style="margin-left: 30px;"><label style="font-size: 100%; padding-right: 5px; padding-top: 22px; padding-bottom: 20px;">Add Product</label></a>
